...
@Service
public class S052010060Logic implements S052010060Spec {

    private final S052010060Repository repository;
    private final CustomResponse res;

    public S052010060Logic(S052010060Repository repository, CustomResponse res) {
